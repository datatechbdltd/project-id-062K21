...
<ul class="menu-nav">
    ...
    <li class="menu-section">
        <h4 class="menu-text">Backend Table</h4>
            ...
            <ul class="menu-subnav">
                ...
                <li class="menu-item" aria-haspopup="true">
                    <a href="{{route('package.create')}}" class="menu-link">
                        ...
                        <span class="menu-text">Create Packages</span>
                    </a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item @if(Request::is('*/language/create')) menu-item-active @endif" aria-haspopup="true">
                                <a href="{{ route('setting.language.create') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            <li class="menu-item @if(Request::is('*/identity')) menu-item-active @endif" aria-haspopup="true">
                                <a href="{{ route('setting.identity.index') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            <li class="menu-item @if(Request::is('*/contact')) menu-item-active @endif" aria-haspopup="true">
                                <a href="{{ route('setting.contact.index') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            <li class="menu-item @if(Request::is('*/seo')) menu-item-active @endif" aria-haspopup="true">
                                <a href="{{ route('setting.seo.index') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
