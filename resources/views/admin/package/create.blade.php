...
@push('title') Create Package @endpush
@push('style')
                        ...
                        <form action="{{route('package.store')}}" method="post" >
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Price
                                        <span class="text-danger">*</span></label>
                                    <input type="number" name="price" id="price" class="form-control" min="1" step="0.01"  placeholder="Enter price" />
                                    @error('price')
                                    <span class="form-text text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group mb-1">
                                    ...
                                    <textarea name="description" id="" class="description"></textarea>
                                    @error('description')
                                    <span class="form-text text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    <label>Offer Percent
                                        <span class="text-danger">*</span></label>
                                    <input type="number" name="offer_percent" id="offer_percent" class="form-control" min="1"  placeholder="Enter offer percent" />
                                    @error('offer_percent')
                                    <span class="form-text text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    <label>Color
                                        <span class="text-danger">*</span></label>
                                    <input class="form-control" name="color" type="color" id="example-color-input">
                                    @error('color')
                                    <span class="form-text text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
