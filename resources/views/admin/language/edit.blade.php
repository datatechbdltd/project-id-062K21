                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('setting.language.index') }}" class="text-muted">Languages</a>
                            </li>
                            <li class="breadcrumb-item">
                                <a href="javascript:0;" class="text-muted">Edit</a>
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    ...
                    <div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="left">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 m-0">
                            ...
                            <ul class="navi navi-hover">
                                ...
                                <li class="navi-item">
                                    <a href="{{ route('setting.language.edit', $language) }}" class="navi-link">
														<span class="navi-text">
															<span class="label label-xl label-inline label-light-success">{{ $language->name }}</span>
														</span>
                                    </a>
                                </li>
                                @endforeach
            ...
            <div class="container">
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <h3 class="card-title">
                            {{ __('Edit') }} &nbsp; <b>{{ $language->name }}</b>
                        </h3>
                    </div>
                    <!--begin::Form-->
                    <form action="{{ route('setting.language.update', $language) }}" method="POST" class="form" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="card-body">
