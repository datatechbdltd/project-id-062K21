                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($languages as $language)
                                <tr>
                                    ...
                                    <td class="row">
                                        <a href="{{ route('setting.language.edit', $language) }}" class="btn btn-shadow btn-icon btn-warning">
                                            <i class="flaticon2-edit"></i>
                                        </a>
                                        <a href="{{ route('setting.language.show', $language) }}" class="btn btn-shadow btn-icon btn-info">
                                            <i class="flaticon-medical icon-lg"></i>
                                        </a>
                                        <form action="{{ route('setting.language.destroy',$language) }}" method="post">
                                            @csrf
                                            @method('delete')
                                            <button class="btn btn-shadow btn-icon btn-danger delete-confirm" data-name="{{ $language->name }}" type="submit">
