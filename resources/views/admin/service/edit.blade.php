...
@push('title') Edit Service @endpush
@push('style')
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="" class="text-muted">Edit Service</a>
                        </li>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="language" name="language">
                                        ...
                                        @foreach($languages as $language)
                                          <option value="{{$language->id}}"  @if($service->language_id == $language->id) selected @endif>{{$language->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('language')
                                ...
                                <div class="form-group">
                                    ...
                                    @if($service->icon != null)
                                        <img src="{{ asset($service->icon) }}" width="15%">
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    @if($service->featured_image != null)
                                        <img src="{{ asset($service->featured_image) }}" width="15%">
                                    @endif
                                </div>
                                <div class="form-group">
                                    ...
                                    <span class="form-text text-danger">{{ $message }}</span>
                                    @enderror
                                    @if($service->attachment_file != null)
                                        <img src="{{ asset($service->attachment_file) }}" width="15%">
                                    @endif
                                </div>
                                <div class="form-group mb-1">
                                    <label for="short_description">Short Description</label>
                                    <textarea class="form-control" name="short_description" id="short_description" rows="3">{{$service->short_description}}</textarea>
                                ...
                                <div class="form-group mb-1">
                                    ...
                                    <textarea name="long_description" id="" class="long_description">{{$service->short_description}}</textarea>
                                    ...
                                    <div class="ml-8 col-form-label">
                                        <div class="radio-inline">
                                            <label class="radio radio-success">
                                                <input @if($service->status == '1') checked   @endif type="radio" value="1"  id="active" name="status"/>
                                                <span></span>
                                                Active
                                            </label>
                                            <label class="radio radio-success">
                                                <input @if($service->status == '0') checked   @endif type="radio" value="0" name="status" id="inactive" />
                                                <span></span>
                                                Inactive
                                            </label>
                                        </div>
